...
The function creates OBIS-compliant tables with:
...
- Build a Darwin Core Archive and EML with `dc_to_archive(raw_to_dc())` (writes the zip and uploads it to SharePoint).
