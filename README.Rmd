...
- Build a Darwin Core Archive and EML with `dc_to_archive()` (writes the zip and uploads it to SharePoint). This reads the Darwin Core tables produced by `raw_to_dc()`.
