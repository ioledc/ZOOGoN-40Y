...
# Aim
This report presents a spatio-temporal analysis of copepod abundance patterns at the MareChiara Long-Term Ecological Research (LTER) station in the Gulf of Naples, Mediterranean Sea, covering data recorded between 1984 and 2024.
...
Below you can see some examples of heatmap for different taxonomic levels: 
```{r}
#| echo: true
#| code-fold: true
...
Here you can see some examples for temporal trend: 
```{r}
#| echo: true
#| code-fold: true 
