...
- Production registration: use `register_gbif_dataset()` with your real
  ...
  DwC-A URL.
- Test registration: use `register_gbif_dataset_test()` with the
  GBIF-Test demo credentials (ws_client_demo/Demo123) and your public
  DwC-A URL to exercise the flow safely.
