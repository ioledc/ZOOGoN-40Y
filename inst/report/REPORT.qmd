...
The full source code of the ZooGoN pipeline is available on 
[**GitHub**](https://github.com/ioledc/ZOOGoN-40Y/tree/main).
...
- `preprocess_surveys()` cleans and transforms raw survey data, computes abundance values (ind m⁻³) by sex and life stage, and harmonizes taxonomic identifiers against [**WoRMS**](https://www.marinespecies.org/) via AphiaID.
